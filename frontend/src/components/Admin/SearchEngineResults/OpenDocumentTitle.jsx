                    ...
                    <div className="row justify-content-space align-items-start">
                        <div className="col-lg-6">
                            <ul>
                                ...
                                <li className='text-color-code mb-3'><span><b>Author Information</b>  <span className="text-details">
                                    <ul>
                                        {
                                ...
                                <li className='text-color-code mb-3'><span><b>Document Published</b>:  <span className='text-info'>{moment(ResearchData.details.created_at).format("MMM DD YYYY")}</span></span></li>
                            </ul>
                        </div>
                        <div className="col-lg-6">
